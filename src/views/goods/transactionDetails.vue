        ...
        <a-row :gutter="24">
          <a-col :md="8" :sm="24">
            <a-form-model-item label="明细类型">
              <a-input placeholder="请输入类别" v-model="form.type" />
            </a-form-model-item>
          </a-col>
          <a-col :md="8" :sm="24">
            <a-form-model-item label="订单编号">
              <a-input name="id" v-model="form.id" placeholder="请输入订单编号" />
            </a-form-model-item>
          </a-col>

          <a-col :md="8" :sm="24">
            <a-form-model-item label="时间筛选">
              <a-input placeholder="请选择时间" v-model="form.date" />
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row>
      ...
      <a-card :bordered="false">
        ...
        <a-table :columns="columns" :data-source="list">
          <template slot="sold" slot-scope="text">
            <div class="tag sold_tag">{{ text }}</div>
          </template>
          <template slot="amount" slot-scope="text">
            <div class="tag amount_tag">{{ text }}</div>
          </template>
        </a-table>
      </a-card>
    </div>
