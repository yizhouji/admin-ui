...

  {
    ...
    children: [
      ...
      // 货物管理
      {
        ...
        component: RouteView,
        meta: { title: '货物管理', icon: 'form', permission: ['form'] },
        children: [
          {
          ...
          },
          {
            ...
            meta: { title: '输入货物', keepAlive: true, permission: ['form'] }
          },
          {
            path: '/goods/transactionDetails',
            name: 'TransactionDetails',
            component: () => import('@/views/goods/transactionDetails'),
            meta: { title: '交易明细', keepAlive: true, permission: ['form'] }
          }
        ]
      },
      // 票据

      {
        ...
        component: RouteView,
        meta: { title: '票据打印', icon: 'form', permission: ['form'] },
        children: [
          {
            path: '/bill/newBill',
            name: 'NewBill',
            component: () => import('@/views/bill/newBill'),
            meta: { title: '新建票据', keepAlive: true, permission: ['form'] }
          },
          {
            path: '/bill/soldList',
            name: 'SoldList',
            component: () => import('@/views/bill/soldList'),
            meta: { title: '售出记录', keepAlive: true, permission: ['form'] }
          }
        ]
      },
      // 货物状态
      {
        ...
        component: RouteView,
        meta: { title: '货物状态', icon: 'form', permission: ['form'] },
        children: [
          {
            path: '/goodStstus/backlog',
            name: 'Backlog',
            component: () => import('@/views/goodStstus/backlog'),
            meta: { title: '积压货物', keepAlive: true, permission: ['form'] }
          }
        ]
      },
      {
        ...
        meta: { title: '记事本/图片', keepAlive: true, icon: bxAnaalyse, permission: ['form'] }
      }
      ...
      //   component: RouteView,
      //   meta: { title: '表单', icon: 'form', permission: ['form'] },
      //   children: [
      //     {
      //       path: '/form/base-form',
      //       name: 'BaseForm',
